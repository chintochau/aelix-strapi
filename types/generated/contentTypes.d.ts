...
export interface ApiBlogPostBlogPost extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    project_portfolios: Schema.Attribute.Relation<
      'manyToMany',
...
export interface ApiFaqFaq extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    category: Schema.Attribute.Enumeration<
      ['general', 'pricing', 'technical', 'process']
    >;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiProjectPortfolioProjectPortfolio
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    demo_video_url: Schema.Attribute.String;
    ...
    images: Schema.Attribute.Media<
      ...
      true
    >;
    implementation_details: Schema.Attribute.Blocks;
    ...
    project_duration: Schema.Attribute.String;
    project_summary: Schema.Attribute.Text;
    publishedAt: Schema.Attribute.DateTime;
    results: Schema.Attribute.Component<'project.results', true>;
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    workflow_json: Schema.Attribute.JSON;
  };
}
...
export interface ApiTestimonialTestimonial extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    client_name: Schema.Attribute.String;
    client_photo: Schema.Attribute.Media<
      'images' | 'files' | 'videos' | 'audios'
    >;
    client_title: Schema.Attribute.String;
    ...
    related_project: Schema.Attribute.Relation<
      'manyToOne',
      'api::project-portfolio.project-portfolio'
    >;
